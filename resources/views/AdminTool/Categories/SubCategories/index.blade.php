            ...
            <div class="col-12">
                <div class="content-container">
                    ...
                    <a class="btn btn-sm btn-success float-right mb-3"
                        href="{{ route('AdminTool.categories.subCategories.create', $category) }}" role="button">Add</a>
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">#id</th>
