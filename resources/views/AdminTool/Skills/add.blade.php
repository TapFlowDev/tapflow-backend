...
@section('content')
        ...
        <div class="row">
            <div class="col-10 col-lg-8">
                <div class="content-container">
                    <h1>Add Skills</h1>
                    <form id="addForm" action="{{ route('AdminTool.skills.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3" id="projReq">
                            <div class="row">
                                <div class="col-8">
                                    <label for="skillName">Enter Skill:</label> <input type="text" class="form-control"
                                        id='skillName'>
                                </div>
                                <div class="col-4">
                            ...
                            <div>
                                <label class="text-danger d-none" id='err-label'> skill already exists !</label>
                            </div>
                            @error('skill')
    ...
    <script>
            ...
            checkIfExists(skillNameInput).then(function(data) {
                ...
                if (data.status === 200 && !allInputs.includes(skillTrimed)) {
                    ...
                    newdiv.innerHTML = "<div class='col-8'> Entry " + (counter) +
                        "<br><input type='text' class='form-control' disabled name='skill[]' value='" +
                        skillNameInput +
                    ...
                    var hiddenHtml = `<input type="hidden" name="skill[]" value='${skillNameInput}'>`;
        ...
        function checkIfExists(skill) {
            ...
            var skillTrimed = '';
            return $.ajax({
                url: '/AdminTool/checkSkill/' + skill,
                type: 'get',
                dataType: 'JSON',
                data: {},
