...
class InitialProposals extends Controller
{
    /**
    ...
    public function show($id)
    {
        ...
        $proposal = $this->getData(proposal::where('id', '=', $id)->get())->first();
        // return $proposal;
        // $allTeams = $teamObj->getAllTeams();
        return view("AdminTool.InitialProposals.show", ['proposal' => $proposal]);
    }
    ...
    private function getData($proposals)
    {
        ...
        $proposal->est_min = $proposal->price_min * $proposal->from; 
        $proposal->est_max = $proposal->price_max * $proposal->to; 
        }
        return $proposals;
    }
}
