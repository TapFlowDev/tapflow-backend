...
class Milestones extends Controller
{
                        ...
                        if ($userData['privileges'] == 1) {
                            ...
                            if ($finalProposal['exist'] == 0) {
                                ...
                                if ($new_final_proposal['code'] == 422 || $new_final_proposal['code'] == 500) {
                                    ...
                                    $all_milestones = Milestone::where('final_proposal_id', $finalProposal['final_proposal_id'])->select('id','price','hours');
    ...
    private function calculate_final_price($milestones, $FP_id)
    {
        $total_price = 0;
        $total_hours=0;
        foreach ($milestones as $milestone) {
